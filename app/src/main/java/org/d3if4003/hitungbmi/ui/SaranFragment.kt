package org.d3if4003.hitungbmi.ui
...
import org.d3if4003.hitungbmi.R
import org.d3if4003.hitungbmi.data.KategoriBmi
import org.d3if4003.hitungbmi.databinding.FragmentSaranBinding
...
class SaranFragment : Fragment() {
    ...
    private fun updateUI(kategori: KategoriBmi) {
        ...
        when (kategori) {
            ...
            KategoriBmi.GEMUK -> { actionBar?.title = getString(R.string.judul_gemuk)
