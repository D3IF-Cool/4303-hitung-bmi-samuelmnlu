...
import org.d3if4003.hitungbmi.data.HasilBmi
import org.d3if4003.hitungbmi.data.KategoriBmi
import org.d3if4003.hitungbmi.db.BmiDao
import org.d3if4003.hitungbmi.db.BmiEntity

class HitungViewModel(private val db: BmiDao) : ViewModel() {
    private val hasilBmi = MutableLiveData<HasilBmi?>()

    private val navigasi = MutableLiveData<KategoriBmi?>()
    // Variabel berupa LiveData atau tidak mutable, sehingga gak perlu jadi private
